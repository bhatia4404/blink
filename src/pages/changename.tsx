  ...
  return (
    <div>
      ...
      <div className="text-4xl font-semibold text-blue8 font-roboto flex flex-col gap-4 items-center">
        ...
        <input
          type="text"
          className="outline-0 border-[1px] border-blue6 focus:border-[2px] w-[300px] pl-[10px] rounded-2xl"
          name=""
        ...
        <button
          ...
          onClick={async function () {
            setLoading(true);
            if (inputFirstname.length < 2 || inputLastname.length < 2) {
              setMessage(
                "Firstname and Lastname should have atleast two characters."
              );
              setLoading(false);
              return;
            }
